...
func AbsolutePath(pathTaken []mazegrid.MazeSquare) ([]mazegrid.MazeSquare, float64) {
	var finalPath []mazegrid.MazeSquare // Stores the final path
	var totalWeight float64             // Accumulates the total weight of the path
...
func appendNode(i int, pathTaken []mazegrid.MazeSquare, finalPath []mazegrid.MazeSquare, totalWeight float64) (mazegrid.MazeSquare, []mazegrid.MazeSquare, float64) {
