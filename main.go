...
func NewGame() *Game {
	...
	ghost.Init(gameGridDFS[mazeSizeOriginal/2][mazeSizeOriginal/2].NodePosition, color.RGBA{200, 0, 0, 255}, algorithms.BFSAlgo, pacman.GetPosition(), gameGridDFS, maze.Pellots)
